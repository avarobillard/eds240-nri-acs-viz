...
I reordered the states based on their national risk scores in order to better show California in comparison to other states. I also used gghighlight with a selected color to emphasize California's boxplot as there were 50 states shown. I also customized my theme to create a visual hierarchy of text, where the title is largest and the axes labels are the smallest. Lastly, I increased the figure height to 10 to make the y-axis legible.
